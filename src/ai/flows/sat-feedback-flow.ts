...
const prompt = ai.definePrompt({
    ...
    1.  Start by acknowledging their effort (e.g., "Nice work knocking out your first...").
    2.  Identify ONE specific area or topic where they did well.
    3.  Identify ONE specific area where they struggled the most (lost the most points).
