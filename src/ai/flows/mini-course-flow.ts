...
const prompt = ai.definePrompt({
    ...
    Your main task is to generate a complete, multi-module course based on the user's details.
    ...
    For each module, create 4-6 detailed chapters.

    **CRITICAL INSTRUCTION**: The 'content' for each chapter MUST be the length of a detailed essay, comprising at least 5 to 7 substantial paragraphs. Do not provide short summaries. The goal is to create a rich, comprehensive, and word-heavy educational resource for the user to study.
    ...
    For each chapter within a module, provide a title, the main educational content (which must be detailed and comprehensive), and a tailored, interactive activity.
    `,
});
