...
const ChapterSchema = z.object({
  ...
  interactiveTool: z.string().optional().describe("An optional URL to an interactive tool or simulation (e.g., a PhET simulation embed URL). This should be a valid URL or an empty string."),
});
