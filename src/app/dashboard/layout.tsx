...
const navItems = [
    ...
    { href: '#', icon: <VisualToolsIcon />, label: 'Visual Tools' },
    { href: '#', icon: <CommunityIcon />, label: 'Community' },
];
