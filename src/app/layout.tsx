    ...
    return (
        <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none">
            ...
            <svg viewBox="0 0 800 600" className="absolute inset-0 w-full h-full">
                {/* Christmas Tree */}
                <g transform="translate(100, 250) scale(12)">
                  ...
                  <path fill="#5c913b" d="M23.301 7.832C20.983 5.845 19.68 3 18.472 3s-2.511 2.845-4.83 4.832c-1.843 1.579 2.415 1.933 4.83 0 2.414 1.932 6.673 1.578 4.829 0"/>
                  <circle cx="16.5" cy="12.042" r="1.5" fill="#ffcc4d"/><circle cx="20" cy="25" r="2" fill="#ffcc4d"/><circle cx="22.5" cy="15.5" r="2.5" fill="#dd2e44"/><circle cx="10" cy="26" r="2" fill="#dd2e44"/><circle cx="14" cy="19" r="2" fill="#a6d388"/><circle cx="26" cy="23" r="2" fill="#a6d388"/>
                  <path fill="#ffac33" d="M19.379 1.679c.143.275.512.549.817.609l1.379.269c.305.06.377.29.159.512l-.983 1.004c-.217.222-.365.657-.326.965l.17 1.394c.038.309-.159.448-.438.31L18.9 6.117c-.279-.138-.738-.144-1.02-.013l-1.274.594c-.282.13-.476-.014-.43-.322l.205-1.39c.045-.307-.091-.745-.302-.973l-.959-1.027c-.212-.227-.135-.457.172-.508l1.385-.234c.307-.051.681-.316.832-.588L18.19.427c.151-.272.394-.269.537.006z"/>
                </g>
