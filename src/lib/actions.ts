...
import generateFeedback from '@/ai/flows/sat-feedback-flow';
...
export { 
    ...
    generateSatStudySession as generateSatStudySessionAction,
    generateFeedback as generateFeedbackAction,
};
