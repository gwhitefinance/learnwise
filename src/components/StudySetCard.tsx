...
import { Bookmark, Settings, Play, ChevronDown, PenTool, BookMarked, GraduationCap, Gamepad2, Headphones } from 'lucide-react';
...
const StudySetCard = ({ course }: { course: Course }) => {
    return (
        <div className="bg-gradient-to-br from-primary to-indigo-700 p-8 rounded-3xl shadow-2xl shadow-blue-500/40 text-white">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                ...
                <div className="bg-white/20 backdrop-blur-sm p-4 rounded-2xl flex items-center gap-4">
                  <div className="w-10 h-10 flex items-center justify-center rounded-full bg-blue-200 text-blue-600 font-bold"><BookMarked className="w-5 h-5" /></div>
