...
const shirtComponents: Record<string, React.FC> = {
    ...
    "Ringer Tee": () => ( <g><path d='M70 110 L130 110 L130 150 L70 150 Z' fill='white' /><rect x='70' y='110' width='60' height='5' fill='#dc2626' /><path d='M65 110 L70 115' stroke='#dc2626' strokeWidth='4' /><path d='M135 110 L130 115' stroke='#dc2626' strokeWidth='4' /></g> ),
    "Raglan Shirt": () => ( <g><path d='M70 110 L130 110 L130 150 L70 150 Z' fill='white' /><path d='M70 110 L100 130 L130 110 Z' fill='#65a30d' /></g> ),
    "Graphic Tee": () => ( <g><path d='M70 110 L130 110 L130 150 L70 150 Z' fill='#1e293b'/><text x='100' y='135' fontSize='24' fill='white' textAnchor='middle'>AI</text></g> ),
    "Hawaiian Shirt": () => ( <g><path d='M65 105 L135 105 L135 155 L65 155 Z' fill='#2563eb' /><text x='80' y='125' fontSize='12'>🌴</text><text x='110' y='145' fontSize='12'>🌺</text><text x='95' y='130' fontSize='12'>☀️</text></g> ),
    ...
    "Tie-Dye Shirt": () => ( <g><circle cx='100' cy='130' r='35' fill='yellow' /><circle cx='100' cy='130' r='25' fill='orange' /><circle cx='100' cy='130' r='15' fill='red' /><path d='M65 105 L135 105 L135 155 L65 155 Z' fill='url(#tieDye)' clipPath='url(#shirt-clip)' /><defs><radialGradient id='tieDye'><stop offset='10%' stopColor='red' /><stop offset='50%' stopColor='yellow' /><stop offset='95%' stopColor='blue' /></radialGradient><clipPath id='shirt-clip'><path d='M65 105 L135 105 L135 155 L65 155 Z' /></clipPath></defs></g> ),
    ...
    "Kimono": () => ( <g><path d='M70 105 L130 105 L130 160 L70 160 Z' fill='#831843'/><path d='M70 105 L100 160' stroke='#fecdd3' strokeWidth='5' /><path d='M130 105 L100 160' stroke='#fecdd3' strokeWidth='5' /><rect x='90' y='120' width='20' height='5' fill='#f9a8d4' /></g> ),
    "Raincoat": () => ( <g><path d='M65 105 L135 105 L135 160 L65 160 Z' fill='#facc15' /><path d='M65 90 C 65 70 135 70 135 90' fill='#facc15' /></g> ),
    "Puffy Vest": () => ( <g><path d='M75 105 L125 105 L125 155 L75 155 Z' fill='#4f46e5' /><path d='M75 120 L125 120' stroke='white' strokeOpacity='0.2' strokeWidth='4' /><path d='M75 135 L125 135' stroke='white' strokeOpacity='0.2' strokeWidth='4' /></g> ),
    "Fur Coat": () => ( <g><path d='M60 105 L140 105 L140 160 L60 160 Z' fill='#d2b48c' /><path d='M60 105 Q 100 90 140 105' fill='#f5f5dc'/></g> ),
    "Dragon Scale Mail": () => ( <g><defs><pattern id='scales' patternUnits='userSpaceOnUse' width='10' height='10'><path d='M 5,0 l 5,5 l -5,5 l -5,-5 z' fill='#22c55e' stroke='#166534' strokeWidth='0.5'/></pattern></defs><rect x='65' y='105' width='70' height='50' fill='url(#scales)' /></g> ),
    ...
    "Steampunk Attire": () => ( <g><path d='M75 105 L125 105 L120 155 L80 155 Z' fill='#8B4513' /><path d='M80 105 L120 105 L115 150 L85 150 Z' fill='white' /><circle cx='85' cy='115' r='5' fill='#DAA520' /><circle cx='115' cy='135' r='8' stroke='#DAA520' strokeWidth='2' fill='none'/></g> ),
    "Glowing Runes": () => ( <g><path d='M70 105 L130 105 L130 155 L70 155 Z' fill='black'/><text x='100' y='135' fontSize='30' fill='#0ea5e9' textAnchor='middle' style={{textShadow:'0 0 5px #0ea5e9'}}>ᛗ</text></g> ),
