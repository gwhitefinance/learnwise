...
import { Instagram, Twitter, Linkedin, Youtube, Mail, Phone, MapPin, ArrowRight, BrainCircuit } from 'lucide-react'
    ...
    <footer className="relative bg-black border-t border-gray-800/50">
          ...
          >
            <div className="flex gap-4">
              ...
              <Button
                type="submit"
                size="icon"
                className="bg-white text-black hover:bg-gray-100 h-12 w-12"
              >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          ...
          >
            <div className="group flex items-center justify-center lg:justify-start gap-2">
            ...
            <p className="text-gray-400 text-lg leading-relaxed max-w-md mx-auto lg:mx-0">
              Empowering learners of all types to build powerful study habits that drive real understanding and
              sustainable growth.
            </p>
